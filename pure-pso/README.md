...
| `images.plugin.tag`                            | The image tag to pull                                                                                                                                      | `v6.2.1`                                      |
...
| `images.database.cockroachOperator.tag`        | The image tag to pull                                                                                                                                      | `v1.2.1`                                      |
...
| `images.database.deployer.tag`                 | The image tag to pull                                                                                                                                      | `v1.2.1`                                      |
