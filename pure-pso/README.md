...
| `flasharray.sanType`                           | Block volume access protocol, one of `ISCSI`, `FC` or `NVMEOF-RDMA`                                                                                        | `ISCSI`                                       |
...
| `DBTopology.enforce`                           | Enforce DB topology, more details [here](../docs/db-topology.md)
| `images.pullSecrets`                            | List of [secrets](https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/) to use for image registry authentication | `[]` |
| `images.plugin.name`                           | The image name to pull from                                                                                                                                | `purestorage/k8s`                             |
| `images.plugin.tag`                            | The image tag to pull                                                                                                                                      | `v6.2.0-rc1`                                  |
...
| `images.database.cockroachOperator.tag`        | The image tag to pull                                                                                                                                      | `v1.2.0-rc1`                                  |
...
| `images.database.deployer.tag`                 | The image tag to pull                                                                                                                                      | `v1.2.0-rc1`                                  |
| `images.database.psctl.name`                   | The image name of PSCTL                                                                                                                                    | `purestorage/psctl`                           |
| `images.database.psctl.tag`                    | The image tag to pull                                                                                                                                      | `v1.1.0-rc1`                                  |
...
| purestorage/cockroach-operator           | v1.2.0-rc1 |
| purestorage/dbdeployer                   | v1.2.0-rc1 |
| purestorage/psctl                        | v1.1.0-rc1 |
| purestorage/k8s                          | v6.2.0-rc1 |
