...
| `images.plugin.tag`                            | The image tag to pull                                                                                                                                      | `v6.2.0`                                      |
...
| `images.database.cockroachOperator.tag`        | The image tag to pull                                                                                                                                      | `v1.2.0`                                      |
...
| `images.database.deployer.tag`                 | The image tag to pull                                                                                                                                      | `v1.2.0`                                      |
| `images.database.psctl.name`                   | The image name of PSCTL                                                                                                                                    | `purestorage/psctl`                           |
| `images.database.psctl.tag`                    | The image tag to pull                                                                                                                                      | `v1.1.0`                                      |
